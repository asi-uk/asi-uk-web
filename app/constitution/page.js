      ...
      <ol class="list-decimal list-outside">
        <li class="text-xl md:text-2xl text-asi-blue font-semibold"><h2 className="my-4">Definitions</h2>
          <ul className="list-none leading-normal text-sm md:text-base text-black font-normal">
            ...
            <li class="mb-4"><p>&ldquo;<strong>Close Relative</strong>&rdquo; is an individual who is either a father, mother, brother, sister, husband, wife, son, daughter, grandmother and grandfather by blood (not marriage), grandson, granddaughter, mother-in-law, father-in-law, daughter-in-law, son-in-law, grandmother-inlaw, grandfather-in-law, brother-in-law, sister-in-law, uncle by blood or marriage, aunt by blood or marriage, nephew or niece by blood or marriage, or first cousin, equivalent stepfamily members, a legal dependent, or any other person so interpreted by the General Meeting and/or Executive. By blood or marriage refers to the individual&rsquo;s relative by blood or marriage.</p></li>
            ...
            <li class="mb-4"><p>&ldquo;<strong>Executive, the</strong>&rdquo; is the Association&rsquo;s board occupied by Executive Members who exercise their authority in operating the Association in accordance with this constitution. &ldquo;Executive Member&rdquo; is the officer appointed to the Association&rsquo;s board and upon whom authority is conferred to act in the best interests of the Association.</p></li>
            <li class="mb-4"><p>&ldquo;<strong>Entity</strong>&rdquo; and/or &ldquo;<strong>Entities</strong>&rdquo; are self-employed individuals, entrepreneurs, companies, associations, missionary organisations, not-for-profit organisations, individuals running their own ministry, and groups. This is not an exhaustive list and the Executive can use its discretion to add to this list.</p></li>
        ...
        <ol class="list-decimal list-outside text-sm md:text-base text-black font-normal">
          <li class="mb-4">The purpose of the association is to:
            <ol class="list-decimal list-outside text-sm md:text-base">
              ...
              <li>Motivate members of the Church who are self-employed or who own privatelyowned businesses or who own or manage non-profit associations in harmony with the goals and values of the Church, to cooperate with each other and with the entities of the Church and to work in harmony with and for the benefit of the Church in fulfilling its gospel commission and thus support the spreading of the Adventist message.</li>
        ...
        <li class="text-xl md:text-2xl text-asi-blue font-semibold"><h2 className="my-4">Membership and Voting Rights</h2>
          <ol class="list-decimal list-outside text-sm md:text-base text-black font-normal">
            ...
            <li class="mb-4">&ldquo;<strong>Ordinary Membership</strong>&rdquo; status shall be granted to Entities and to Professionals, and shall have conferred to them one vote. They are subject to the following sub-clauses:
              <ol class="list-decimal list-outside text-sm md:text-base">
                <li>Entity Membership shall be granted to an Entity where the control is exercised over it by an Individual or individuals. Whereby an Entity consists of several subsidiaries and whereby each subsidiary is applying for membership, each subsidiary can apply for membership under its own name. The subsidiary does not receive Voting Rights and no extra votes are given to the parent entity. An Entity applying for membership shall not directly or indirectly be controlled by the Church.</li>
        ...
        <li class="text-xl md:text-2xl text-asi-blue font-semibold"><h2 className="my-4">Membership Application Process</h2>
          <ol class="list-decimal list-outside text-sm md:text-base text-black font-normal">
            ...
            <li class="mb-4">Determining criteria for Membership:
              <ol class="list-decimal list-outside text-sm md:text-base">
                <li>The controlling individual of an Entity shall be a practicing member of the Church and be of good and regular standing, and have a positive standing in the community.</li>
                <li>The Entity proper shall operate in harmony with the mission of the Church, shall follow the ethical, financial and spiritual principles of the Church, and shall exert a positive Adventist influence within their environment.</li>
        ...
        <li class="text-xl md:text-2xl text-asi-blue font-semibold"><h2 className="my-4">Termination of Membership</h2>
          <ol class="list-decimal list-outside text-sm md:text-base text-black font-normal">
            <li class="mb-4">Membership in the Association shall end by submitting a formal withdrawal from the Association, by dissolution of the Entity, death, expulsion, or ending Church membership.</li>
        ...
        <li class="text-xl md:text-2xl text-asi-blue font-semibold"><h2 className="my-4">The General Meeting and Extraordinary Meeting</h2>
          <ol class="list-decimal list-outside text-sm md:text-base text-black font-normal">
            ...
            <li class="mb-4">Each Member is entitled to submit in writing additions to the Agenda up until two weeks before the General Meeting. The chairperson shall announce any additions to the Agenda at the beginning of the General Meeting.</li>
