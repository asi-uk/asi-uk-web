...
export default function Membership() {
  ...
  <div className="flex items-center justify-center w-screen">
    <div className="max-w-screen-md mx-auto">
      ...
      <h1 className="heading-page">Membership</h1>
      ...
      <h2 className="heading-section">Information for Membership</h2>
      ...
      <div className="my-10">
        <h3 className="heading-sub">Types of Membership in ASI UK</h3>
        ...
        <div className="my-6">
          <h4 className="heading-minor">1. Ordinary Member</h4>
        ...
        <div className="my-6">
          <h4 className="heading-minor">2. Supporting Member</h4>
