...
export default function ConventionRegisterError({
    error,
    reset,
}: {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
            <h1 className="text-4xl font-bold text-asi-blue mb-4">Registration Error</h1>
            <p className="text-slate-500 mb-8 text-center max-w-md">
                Something went wrong with your registration. Please try again or contact us if the problem persists.
            </p>
